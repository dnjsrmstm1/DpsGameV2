...
// 보주 (원본 맵 12종 — 응축된 무색조각으로 구입하여 영구 강화)
// 원본 UI: [1] [10] [100] [M] 버튼으로 보주 수량 구입
...
const 초기보주: 보주목록 = { 신위: 0, 절명: 0, 풍요: 0, 영겁: 0, 명운: 0, 성운: 0, 천운: 0, 무위: 0, 풍성: 0, 인연: 0, 폭식: 0, 공명: 0 }
// 보주 1개 구입 비용 (응축된 무색조각)
const 보주구입비용: Record<보주타입, number> = {
  신위: 5, 절명: 10, 풍요: 3, 영겁: 8, 명운: 4, 성운: 4, 천운: 6, 무위: 15, 풍성: 5, 인연: 3, 폭식: 4, 공명: 4,
}
...
// 사용자 지정 초기비용 (무색조각). 동적: base × (1 + 보유/10)
...
function 보석보너스합산(b: 보석목록) {
  ...
  // 섬세: 크레딧 복리 (1%/개)
  const 크레딧배수 = Math.pow(1.01, b.섬세)
          ...
          <ScrollView style={{ maxHeight: 360 }}>
            ...
            {스텟탭 === '보석' && (() => {
              const 보석정보in: { 종류: 보석타입; 이모지: string; 설명: string; 효과: string }[] = [
                ...
                { 종류: '섬세',    이모지: '🔍', 설명: '섬세의 보석',       효과: '크레딧 ×1.01/회 (복리)' },
              ]
              return (
                <>
